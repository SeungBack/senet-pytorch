...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes=100, block=ResBottleNeck, inplanes=64, expansion=4):
        super().__init__()
        ...
        self.conv_init = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=inplanes, kernel_size=3, bias=False, stride=1, padding=1),
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
        )
        n_layers = [3, 6, 6, 3]
